...
export function getMinimalToolDefinitions() {
  ...
  // manifest is byte-identical to the historical Copilot Studio surface so
  // the existing agents (ess-servicenow-catalog-extension,
  // employee-self-service-it, [CTOP] - SnowMCP OrderCat) keep working.
  ...
  // and keeps the manifest byte-identical to historical Copilot Studio
  // expectations.
